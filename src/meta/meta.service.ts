...
export class MetaService {
  ...
  async sendMessage(dto: MetaMessageDto) {
    ...
    return this.graphRequest('POST', `/${this.requiredPhoneNumberId()}/messages`, payload);
  }
  ...
  async createTemplate(dto: CreateTemplateDto) {
    ...
    return this.graphRequest('POST', `/${this.requiredWabaId()}/message_templates`, payload);
  }

  async getTemplates() {
    return this.graphRequest('GET', `/${this.requiredWabaId()}/message_templates`);
  }
  ...
  async deleteMedia(id: string) {
    return this.graphRequest('DELETE', `/${id}`);
  }
